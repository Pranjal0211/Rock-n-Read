...
function Navbar() {
  ...
  return (
    <header className="bg-transparent text-gray-100 py-4 px-6 z-50 fixed w-full">
      <div className="container mx-auto flex items-center justify-between">
        ...
        {/* Desktop Menu */}
        <nav className="hidden md:flex gap-4 ml-auto items-center">
          <Link
            href="#"
            className="px-4 py-2 rounded-md hover:bg-gray-100 hover:text-gray-900 transition-colors duration-200"
          >
            Home
          </Link>
          <Link
          ...
          <div className="relative group">
            ...
            {dropdownOpen === 3 && (
              <div className="absolute left-0 mt-2 w-56 bg-white text-gray-800 shadow-lg rounded-md">
                <Link
                  href="#"
                  onClick={closeMenu}
                  className="block px-4 py-2 hover:bg-gray-200"
                >
                  Why Singing Works--Brain Research
                </Link>
                <Link
                  href="#"
                  onClick={closeMenu}
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="absolute inset-0 bg-black bg-opacity-90 text-gray-100 flex flex-col items-center justify-start py-8 px-4 space-y-4">
            <Link
              href="#"
              onClick={closeMenu}
              className="hover:bg-gray-100 hover:text-gray-900 px-4 py-2 rounded-md"
            >
              Home
            </Link>
            <Link
